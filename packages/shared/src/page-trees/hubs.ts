    ...
    case '/enviki': {
      ...
      const nodes: Record<string, BuilderNode> = {
        ...
        p_wiki_subhubs: makeParagraph(
          'p_wiki_subhubs',
          'cont_wiki_subhubs',
          `<div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(280px, 1fr)); gap:24px; width:100%; box-sizing:border-box;">
            <a href="/behind-the-buzz/" class="enviki-subhub-card" style="text-decoration:none; display:flex; flex-direction:column; justify-content:flex-end; min-height:360px; height:380px; padding:32px; border-radius:25px; background-color:#1e293b; background-image:linear-gradient(to top, rgba(0, 0, 0, 0.75) 0%, rgba(0, 0, 0, 0.2) 50%, transparent 80%), url('${resolveCmsImage('/images/buzz-updated.avif')}'); background-size:cover; background-position:center; transition:transform 0.25s ease, box-shadow 0.25s ease; box-shadow:0 10px 25px rgba(0,0,0,0.1);">
              <h3 style="color:#FFFFFF; font-size:32px; font-weight:400; font-family:'Neue Montreal', sans-serif; margin:0; line-height:1.15; text-shadow:0 2px 10px rgba(0, 0, 0, 0.7);">Behind<br />the Buzz</h3>
            </a>
            <a href="/glossary-zone/" class="enviki-subhub-card" style="text-decoration:none; display:flex; flex-direction:column; justify-content:flex-end; min-height:360px; height:380px; padding:32px; border-radius:25px; background-color:#1e293b; background-image:linear-gradient(to top, rgba(0, 0, 0, 0.75) 0%, rgba(0, 0, 0, 0.2) 50%, transparent 80%), url('${resolveCmsImage('/images/glossary-zone-enviki.avif')}'); background-size:cover; background-position:center; transition:transform 0.25s ease, box-shadow 0.25s ease; box-shadow:0 10px 25px rgba(0,0,0,0.1);">
              <h3 style="color:#FFFFFF; font-size:32px; font-weight:400; font-family:'Neue Montreal', sans-serif; margin:0; line-height:1.15; text-shadow:0 2px 10px rgba(0, 0, 0, 0.7);">Glossary<br />Zone</h3>
            </a>
            <a href="/how-to-articles/" class="enviki-subhub-card" style="text-decoration:none; display:flex; flex-direction:column; justify-content:flex-end; min-height:360px; height:380px; padding:32px; border-radius:25px; background-color:#1e293b; background-image:linear-gradient(to top, rgba(0, 0, 0, 0.75) 0%, rgba(0, 0, 0, 0.2) 50%, transparent 80%), url('${resolveCmsImage('/images/how-to-article.avif')}'); background-size:cover; background-position:center; transition:transform 0.25s ease, box-shadow 0.25s ease; box-shadow:0 10px 25px rgba(0,0,0,0.1);">
              <h3 style="color:#FFFFFF; font-size:32px; font-weight:400; font-family:'Neue Montreal', sans-serif; margin:0; line-height:1.15; text-shadow:0 2px 10px rgba(0, 0, 0, 0.7);">How to<br />Articles</h3>
            </a>
          </div>`,
          {},
          'Sub-Hubs Cards Grid'
        ...
        p_wiki_vantage_card: makeParagraph(
          'p_wiki_vantage_card',
          'cont_wiki_vantage',
          `<div style="border-radius:25px; background-color:#111827; background-image:linear-gradient(to right, rgba(0, 0, 0, 0.65) 0%, rgba(0, 0, 0, 0.45) 60%, rgba(0, 0, 0, 0.25) 100%), url('${resolveCmsImage('/images/vantage-bg-image.avif')}'); background-size:cover; background-position:center; padding:56px 48px; color:#FFFFFF; display:flex; flex-direction:column; gap:24px; position:relative; box-shadow:0 12px 32px rgba(0,0,0,0.15);">
            <h2 style="color:#FFFFFF; font-size:38px; font-weight:500; font-family:'Neue Montreal', sans-serif; margin:0; line-height:1.2; text-shadow:0 2px 12px rgba(0, 0, 0, 0.5);">Vantage 2025: The ESG Reset Opportunity</h2>
            <div style="display:flex; flex-wrap:wrap; justify-content:space-between; align-items:flex-end; gap:24px; width:100%;">
              <p style="color:#FFFFFF; font-size:18px; line-height:30px; font-family:'Neue Montreal', sans-serif; max-width:720px; margin:0; opacity:0.95; text-shadow:0 1px 6px rgba(0, 0, 0, 0.4);">Despite global pushback, ESG momentum in India is rising. This report shows that a strong rebound is underway, as responsible practices remain essential for long-term business growth and resilience. Our report, Vantage, offers expert insights to navigate this evolving ESG landscape.</p>
              <a href="https://envintcms.s3.ap-south-1.amazonaws.com/media/uploads/Envint-Vantage-ESG-Reset.pdf" target="_blank" rel="noopener noreferrer" class="vantage-card-btn" style="display:inline-block; background-color:#FFFFFF; color:#004E35; font-family:'Neue Montreal', sans-serif; font-size:18px; font-weight:600; padding:16px 36px; border-radius:25px; text-decoration:none; box-shadow:0 4px 15px rgba(0, 0, 0, 0.2); white-space:nowrap; transition:all 0.25s ease;">Read the report now</a>
            </div>
          </div>`,
          {},
